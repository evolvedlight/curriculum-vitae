...
\begin{itemize}%
\item \textbf{RabbitMQ: } I initiated and completed most of the work to migrate from MSMQ to RabbitMQ, recognising that otherwise other progress would be blocked. The benefit of this was to continue using the up to date Microsoft tools after MSMQ's obsoletion. This was further used by the other Structured Products department teams.
\item \textbf{Kubernetes/Containers:} I initiated the project to start moving onto Linux Containers and Openshift (Kubernetes) for the Structured Products department. The benefit of this was to standardise project architecture, reduce support costs, and improve scalability. This required, ontop of the technical work, coordinating between teams, revising technical standards, evangelising various teams, and solving much historical technical and process debt. 
...
\end{itemize}}
Technologies used: \textbf{C\#, dotnet core, Asp.Net Core, EF Core, Git, REST, RabbitMQ, MSMQ, NServiceBus, Vue.js, gRPC, Swagger}
\newline

\cventry{2020--current}{Founder}{Tangerine Apps}{Zurich}{}{Founder of startup creating tools around APIs and Excel \newline{}%
Founded my own startup to develop small tools that could dramatically increase productivity:%
\begin{itemize}%
...
\cventry{2017--2020}{Senior C\# programmer}{Quartal}{Zurich}{}{Team Lead, responsible for 6 developers. Working with management and colleagues managed to improve efficiency of the team, transforming the team from one that often failured to deliver into a highly performing team.\newline{}%
...
\end{itemize}}
Technologies used: \textbf{C\#, Python, SQL/Oracle, Ansible, Haproxy, Git, Swagger, REST, Teamcity, Jetty, Tibco, NuGet, Kerberos}
\newline
