...
\\\\Much of my initial work focused on the C\# frontend to Booking Tool, a WinForms based application that communicates with the Java backend via XML over REST. It's used by around 1000 users in the bank. Particular accomplishments and improvements include: helping move from .Net 2 to .Net 4.5, upgrading the UI libraries used, profiling the application to make many operations take 100x less time, adding centralised logging, and implementing many features to make it easier to book trades. Working on this for two years has given me a great deal of experience working with UIs and being able to respond quickly to requests for changes and new features, as well as a excellent understanding of how trading works in a bank.
\\The Java backend is a multithreaded, multi-region application that can process an extremely high volume of trades, as well as monitoring trades coming in from other sources to provide user alerts and workflows. From working with this team for the past 2 years, I have developed significant experience in working with high volume, mission critical trading systems.
...
\nopagebreak
\cventry{2011 - 2013}{Bank of America}{Programmer (Graduate)}{UK}{Middle Office Controls Technology}{
